...
::
    ...
    geonature install_gn_module <mon_chemin_absolu_vers_le_module> /suivi_flore_territoire`` (exemple ``geonature install_gn_module /home/`whoami`/gn_module_suivi_flore_territoire-X.Y.Z /suivi_flore_territoire``)
