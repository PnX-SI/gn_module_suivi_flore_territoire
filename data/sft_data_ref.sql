...
-- Insert 25*25 meters  meshes new area type in `ref_geo.bib_areas_types` 
WITH test_exists AS (
    SELECT id_type
...
-------------------------------------------------------------------------------
-- NOMENCLATURE : SFT type site value

-- Add SFT nomenclature value for site type nomenclature (="TYPE_SITE")
WITH test_exists AS (
